...
export const generateInvoicePDF = (transaction: Transaction, profile: BusinessProfile) => {
  try {
    ...
    doc.setFontSize(10).setTextColor(80, 80, 80).setFont('helvetica', 'normal');
    ...
    doc.setFontSize(8).setTextColor(badgeColor[0], badgeColor[1], badgeColor[2]).setFont('helvetica', 'bold');
    ...
    doc.setFontSize(9).setTextColor(160, 160, 160).setFont('helvetica', 'bold');
    doc.text("BILLED TO", 14, 75);
    
    doc.setFontSize(16).setTextColor(30, 30, 30).setFont('helvetica', 'bold');
    ...
    doc.setFontSize(9).setTextColor(100, 100, 100).setFont('helvetica', 'italic');
    ...
    doc.setFontSize(9).setTextColor(150).setFont('helvetica', 'bold');
    doc.text("Authorized Signatory", 171, bottomY + 5, { align: 'center' });

    // 10. Footer Timestamp
    doc.setFontSize(7).setTextColor(200).setFont('helvetica', 'bold');
